...
class Smacv2Task(Task):
    """Enum for SMACv2 tasks — SMACv2 proceduralne + klasyczne mapy SMAC v1."""

    # SMACv2 — proceduralne (jak w BenchMARL)
    PROTOSS_5_VS_5 = None
    ...
    ZERG_20_VS_20 = None
    ZERG_20_VS_23 = None
    # Klasyczne mapy SMAC v1 (praca inżynierska — trudne scenariusze dla DEMIR)
    SIX_H_VS_8Z = None
    CORRIDOR = None
    THREE_M = None
