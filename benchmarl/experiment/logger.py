...
#   [1] # Calculate win_rate from the info dict and saves to W&B and JSON.
...
class Logger:
    ...
    def log_evaluation(
        ...
        #############################
        # [1] Start. Calculate win_rate from the info dict and saves to W&B and JSON.
        #############################
        try:
            battle_won_per_ep = []
            for td in rollouts:
            ...
            pass  # No win_rate info available
        #############################
        # [1] End.
        #############################
